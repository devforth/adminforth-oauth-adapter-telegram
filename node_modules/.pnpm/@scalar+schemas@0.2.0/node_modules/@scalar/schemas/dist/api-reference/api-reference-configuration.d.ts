export declare const apiReferenceConfigurationSchema: import("@scalar/validation").IntersectionSchema<readonly [import("@scalar/validation").ObjectSchema<{
    ...
    showDeveloperTools: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"localhost"> | import("@scalar/validation").LiteralSchema<"always"> | import("@scalar/validation").LiteralSchema<"never">)[]>;
    showToolbar: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"localhost"> | import("@scalar/validation").LiteralSchema<"always"> | import("@scalar/validation").LiteralSchema<"never">)[]>;
    operationTitleSource: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"summary"> | import("@scalar/validation").LiteralSchema<"path">)[]>;
    theme: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"default"> | import("@scalar/validation").LiteralSchema<"alternate"> | import("@scalar/validation").LiteralSchema<"moon"> | import("@scalar/validation").LiteralSchema<"purple"> | import("@scalar/validation").LiteralSchema<"solarized"> | import("@scalar/validation").LiteralSchema<"bluePlanet"> | import("@scalar/validation").LiteralSchema<"deepSpace"> | import("@scalar/validation").LiteralSchema<"saturn"> | import("@scalar/validation").LiteralSchema<"kepler"> | import("@scalar/validation").LiteralSchema<"elysiajs"> | import("@scalar/validation").LiteralSchema<"fastify"> | import("@scalar/validation").LiteralSchema<"mars"> | import("@scalar/validation").LiteralSchema<"laserwave"> | import("@scalar/validation").LiteralSchema<"none">)[]>;
    _integration: import("@scalar/validation").OptionalSchema<import("@scalar/validation").UnionSchema<(import("@scalar/validation").NullableSchema | import("@scalar/validation").LiteralSchema<"elysiajs"> | import("@scalar/validation").LiteralSchema<"fastify"> | import("@scalar/validation").LiteralSchema<"adonisjs"> | import("@scalar/validation").LiteralSchema<"astro"> | import("@scalar/validation").LiteralSchema<"docusaurus"> | import("@scalar/validation").LiteralSchema<"dotnet"> | import("@scalar/validation").LiteralSchema<"express"> | import("@scalar/validation").LiteralSchema<"fastapi"> | import("@scalar/validation").LiteralSchema<"go"> | import("@scalar/validation").LiteralSchema<"hono"> | import("@scalar/validation").LiteralSchema<"html"> | import("@scalar/validation").LiteralSchema<"laravel"> | import("@scalar/validation").LiteralSchema<"litestar"> | import("@scalar/validation").LiteralSchema<"nestjs"> | import("@scalar/validation").LiteralSchema<"nextjs"> | import("@scalar/validation").LiteralSchema<"nitro"> | import("@scalar/validation").LiteralSchema<"nuxt"> | import("@scalar/validation").LiteralSchema<"platformatic"> | import("@scalar/validation").LiteralSchema<"react"> | import("@scalar/validation").LiteralSchema<"rust"> | import("@scalar/validation").LiteralSchema<"svelte"> | import("@scalar/validation").LiteralSchema<"vue">)[]>>;
    ...
    layout: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"modern"> | import("@scalar/validation").LiteralSchema<"classic">)[]>;
    ...
    plugins: import("@scalar/validation").OptionalSchema<import("@scalar/validation").ArraySchema<import("@scalar/validation").FunctionSchema<() => {
        ...
        hooks: import("@scalar/validation").Static<import("@scalar/validation").ObjectSchema<{
            onInit: import("@scalar/validation").OptionalSchema<import("@scalar/validation").FunctionSchema<({ config }: {
                config: any;
            }) => void>>;
            onConfigChange: import("@scalar/validation").OptionalSchema<import("@scalar/validation").FunctionSchema<({ config }: {
                config: any;
            }) => void>>;
    ...
    isLoading: import("@scalar/validation").BooleanSchema;
    hideModels: import("@scalar/validation").BooleanSchema;
    documentDownloadType: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"none"> | import("@scalar/validation").LiteralSchema<"both"> | import("@scalar/validation").LiteralSchema<"yaml"> | import("@scalar/validation").LiteralSchema<"json"> | import("@scalar/validation").LiteralSchema<"direct">)[]>;
    ...
    forceDarkModeState: import("@scalar/validation").OptionalSchema<import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"dark"> | import("@scalar/validation").LiteralSchema<"light">)[]>>;
    ...
    hiddenClients: import("@scalar/validation").OptionalSchema<import("@scalar/validation").UnionSchema<(import("@scalar/validation").ArraySchema<import("@scalar/validation").StringSchema> | import("@scalar/validation").RecordSchema<import("@scalar/validation").StringSchema, import("@scalar/validation").UnionSchema<(import("@scalar/validation").BooleanSchema | import("@scalar/validation").ArraySchema<import("@scalar/validation").StringSchema>)[]>> | import("@scalar/validation").LiteralSchema<true>)[]>>;
    ...
    onSpecUpdate: import("@scalar/validation").OptionalSchema<import("@scalar/validation").FunctionSchema<(input: string) => void>>;
    ...
    tagsSorter: import("@scalar/validation").OptionalSchema<import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"alpha"> | import("@scalar/validation").FunctionSchema<(a: any, b: any) => number>)[]>>;
    operationsSorter: import("@scalar/validation").OptionalSchema<import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"alpha"> | import("@scalar/validation").LiteralSchema<"method"> | import("@scalar/validation").FunctionSchema<(a: any, b: any) => number>)[]>>;
    orderSchemaPropertiesBy: import("@scalar/validation").UnionSchema<(import("@scalar/validation").LiteralSchema<"alpha"> | import("@scalar/validation").LiteralSchema<"preserve">)[]>;
...
export declare const apiReferenceConfigurationWithSourceSchema: (rawInput: unknown) => {
    ...
    onSpecUpdate?: ((input: string) => void) | undefined;
