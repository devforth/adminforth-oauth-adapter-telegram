...
class MysqlConnector extends AdminForthBaseConnector {
    ...
    async getAggregateWithOriginalTypes({ resource, filters, aggregations, groupBy }) {
        ...
        else if ((groupBy === null || groupBy === void 0 ? void 0 : groupBy.type) === 'date_trunc') {
            const g = groupBy;
            ...
            if (groupExpr) {
                if (rows.length === 0) {
                    ...
                    for (const row of rows) {
                        row[alias] = (_b = byGroup.get(String(row.group))) !== null && _b !== void 0 ? _b : null;
                    }
                }
            }
            else {
