...
export default class SocketBroker {
    constructor(adminforth) {
        this.clients = [];
        this.topics = {};
        this.deadCheckerRunning = false;
    ...
    deleteClientFromTopic(client, topic) {
    ...
    async publish(topic, data, filterUsers) {
        if (!this.topics[topic]) {
...
//# sourceMappingURL=socketBroker.js.map