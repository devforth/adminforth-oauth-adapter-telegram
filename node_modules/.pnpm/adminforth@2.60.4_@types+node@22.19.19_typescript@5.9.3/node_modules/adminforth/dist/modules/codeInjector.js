...
class CodeInjector {
    ...
    async checkIconNames(icons) {
        ...
        const iconPackages = (await Promise.allSettled(iconPackageNames.map(async (pkg) => ({
    ...
    registerCustomComponent(filePath) {
    ...
    async prepareSources() {
        ...
        const collectAssetsFromMenu = (menu) => {
            menu.forEach((item) => {
                ...
                meta: { title: '${((_a = item === null || item === void 0 ? void 0 : item.meta) === null || _a === void 0 ? void 0 : _a.title) || (item === null || item === void 0 ? void 0 : item.label) || item.path.replace('/', '')}'}
              },\n`;
                        }
                        else {
                            routes += `{
                ...
                meta: { title: '${((_b = item === null || item === void 0 ? void 0 : item.meta) === null || _b === void 0 ? void 0 : _b.title) || (item === null || item === void 0 ? void 0 : item.label) || item.path.replace('/', '')}'}
              },\n`;
                  ...
                  name: '${item.path}',
                  component: ${getComponentNameFromPath(item.component)},
                  meta: { title: '${((_c = item === null || item === void 0 ? void 0 : item.meta) === null || _c === void 0 ? void 0 : _c.title) || (item === null || item === void 0 ? void 0 : item.label) || item.path.replace('/', '')}'}
                },\n`;
                            const componentName = `${getComponentNameFromPath(item.component)}`;
                            routerComponents += `import ${componentName} from '${item.component}';\n`;
                        }
        ...
        const registerCustomPages = (config) => {
            if (config.customization.customPages) {
                config.customization.customPages.forEach(async (page) => {
                    var _a, _b, _c;
                    const newMeta = await this.migrateLegacyCustomLayout(((_a = page === null || page === void 0 ? void 0 : page.component) === null || _a === void 0 ? void 0 : _a.meta) || {});
                    routes += `{
            path: '${page.path}',
            name: '${page.path}',
            component: () => import('${((_b = page === null || page === void 0 ? void 0 : page.component) === null || _b === void 0 ? void 0 : _b.file) || page.component}'),
            meta: ${JSON.stringify(Object.assign(Object.assign({}, newMeta), { title: ((_c = page.meta) === null || _c === void 0 ? void 0 : _c.title) || page.path.replace('/', '') }))}
          },`;
                });
            }
        };
        ...
        this.adminforth.config.resources.forEach((resource) => {
            ...
            if ((_b = resource.options) === null || _b === void 0 ? void 0 : _b.actions) {
        ...
        if ((_e = this.adminforth.config.customization) === null || _e === void 0 ? void 0 : _e.loginPageInjections) {
        ...
        indexHtmlContent = indexHtmlContent.replace('/* IMPORTANT:ADMINFORTH TITLE */', `${((_j = this.adminforth.config.customization) === null || _j === void 0 ? void 0 : _j.title) || ((_k = this.adminforth.config.customization) === null || _k === void 0 ? void 0 : _k.brandName) || 'AdminForth'}`);
        // we dont't need to add baseUrl in front of assets here, because it is already added by Vite/Vue
        indexHtmlContent = indexHtmlContent.replace('/* IMPORTANT:ADMINFORTH FAVICON */', ((_l = this.adminforth.config.customization.favicon) === null || _l === void 0 ? void 0 : _l.replace('@@/', `/assets/`))
            ||
                `/assets/favicon.png`);
        // inject heads to index.html
        const headItems = (_m = this.adminforth.config.customization) === null || _m === void 0 ? void 0 : _m.customHeadItems;
        if (headItems) {
        ...
        if (!homePagePath) {
            homePagePath = ((_o = this.adminforth.config.menu.filter((mi) => mi.path)[0]) === null || _o === void 0 ? void 0 : _o.path) || `/resource/${(_p = this.adminforth.config.menu.filter((mi) => mi.children)[0]) === null || _p === void 0 ? void 0 : _p.resourceId}`;
        }
        routes += `{
      path: '/',
      name: 'home',
    ...
    async computeSourcesHash(folderPath = this.spaTmpPath(), allFiles = []) {
