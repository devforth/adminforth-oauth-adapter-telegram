...
export type IAdminForthEndpointOptions = IAdminForthAuthenticatedEndpointOptions | IAdminForthNoAuthEndpointOptions;
...
export interface IAdminForthRestAPI {
    ...
    processLoginCallbacks(adminUser: AdminUser, toReturn: {
        ...
        error?: string;
    }, response: any, extra: HttpExtra, sessionDuration?: string): Promise<void>;
}
...
export declare class Aggregates {
    static sum(field: string): IAggregationRule;
    static count(): IAggregationRule;
    static avg(field: string): IAggregationRule;
    static min(field: string): IAggregationRule;
    static max(field: string): IAggregationRule;
    static median(field: string): IAggregationRule;
}
/**
...
export interface IOperationalResource {
    ...
    aggregate: (filter: IAdminForthSingleFilter | IAdminForthAndOrFilter | Array<IAdminForthSingleFilter | IAdminForthAndOrFilter>, aggregations: {
        [alias: string]: IAggregationRule;
    }, groupBy?: IGroupByRule) => Promise<Array<{
        group?: string;
        [key: string]: any;
    }>>;
